    ...
    */
                    ...
                    xhr.onload = function () {
                        if (xhr.readyState === xhr.DONE) {
                            if (xhr.status === 200) {
                                ...
                                MODE_INDICATOR = obj.status[43]
                                SUB_MODE_INDICATOR = obj.status[44]
                                ...
                                if (camera_number >= 50) {
                                    MODE_INDICATOR = obj.status[96]
                                    SUB_MODE_INDICATOR = obj.status[89]
                                    MODES = {
                                        "VIDEO": 1000,
                                        "PHOTO": 1001,
                                        "MSHOT": 1002
                                    ...
                                    case MODES["MSHOT"]:
                                        switch (SUB_MODE_INDICATOR) {
                                            case 0:
                                                ...
                                                break
                                            case 1:
                                            case SUB_MODES["tlphoto"]:
                                            case SUB_MODES["tlvideo"]:
                                            case SUB_MODES["tmwarp"]:
                                                mode = "timelapse"
    ...
    xhr.onload = function () {
        if (xhr.readyState === xhr.DONE) {
            if (xhr.status === 200) {
                var dump = xhr.responseText
                if (dump.indexOf("MAX") != -1) {
                    get_data_cam()
                }
                if (dump.indexOf("HERO8") != -1) {
                    get_data_cam()
                }
                if (dump.indexOf("HERO7") != -1) {
                    get_data_cam()
                }
                if (dump.indexOf("HERO6") != -1) {
                    get_data_cam()
                }
